...
//	  	  sprintf(out_filename+last,"_%db.tzx",speed_value);
		...
		case 3:		//3230
			//out_filename[last+1]='3';out_filename[last+2]='2';out_filename[last+3]='3';out_filename[last+4]='0';
			sprintf(out_filename+last+1,"%d",3230);	 
			break;
		...
		case 7:		//5000
			//out_filename[last+1]='5';out_filename[last+2]='0';out_filename[last+3]='0';out_filename[last+4]='0';
			sprintf(out_filename+last+1,"%d",5000);	 
			break;
		
		case 8:		//5100
			//out_filename[last+1]='5';out_filename[last+2]='1';out_filename[last+3]='0';out_filename[last+4]='0';
			sprintf(out_filename+last+1,"%d",5100);	 
			break;
		
		case 9:		//5500
			//out_filename[last+1]='5';out_filename[last+2]='5';out_filename[last+3]='0';out_filename[last+4]='0';
			sprintf(out_filename+last+1,"%d",5500);	 
			break;
		
		case 10:	//5800
			//out_filename[last+1]='5';out_filename[last+2]='8';out_filename[last+3]='0';out_filename[last+4]='0';
...
byte tzx_header_data[20] = { 0x11, 0x78, 0x08, 0x9B, 0x02, 0xDF, 0x02, 
						//	   0x57, 0x03, 0xAE, 0x06, // ZERO bit pulse 855 && ONE bit pulse 1710	 
							 0x58, 0x02, 0x78, 0x05, // ZERO bit pulse 600 && ONE bit pulse 1400   	   	   	   	   

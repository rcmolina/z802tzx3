...
void print_usage(bool title)
{
	...
	printf("Usage:\n\n");
	printf(" Z802TZX2 Filename.[z80|sna] [Options]\n\n");
	printf(" Options:\n");
...
byte tzx_header[tzx_header_size] =
							{	0x11, 0x78, 0x08, 0x9B, 0x02, 0xDF, 0x02, 0x57, 0x03, 0xAE, 0x06, 0xC4, 0x09, 0x08, 0x64, 0x00, 0x13, 0x00, 0x00,
								0x00, 0x00,			// Basic
								0x11, 0x05, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08,		// Filename
								0xff, 0xff,		// Length of Data block
								0x00, 0x00,		// Autostart line number
...
byte tzx_header_data[20] = { 0x11, 0x78, 0x08, 0x9B, 0x02, 0xDF, 0x02, 0x57, 0x03, 0xAE, 0x06, 0xC4, 0x09, 0x08, 0x64, 0x00, 0xFF, 0xFF, 0xFF, 0xFF };

...
int main (int argc, char *argv[])
{
  ...
  printf ("Succesfully calculated %d blocks!, TAPE TIME: %ds (%02d:%02d)\n", block, (ustape+500000)/1000000,mins,segs);
  fclose (fhi);
  free (mem);
  //system("pause");
  return (0);
  ...
  while (pos < flen - 10)
    ...
    switch (mem[pos - 1])
      ...
      case 0x10: 	 	 	  
				 ...
				 printf("Block %3d Length %6d Normal Speed ,Pause: %4d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);
      ...
      case 0x11: ticksPilotPulse = Get2(&mem[pos]);
				 ...
				 //printf("\n Len: %dchars, Ones: %dbits, acctime: %dus\n", len, BLKnumOnes, ustape);
				 printf("Block %3d Length %6d  Turbo Speed ,Pause: %4d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);	   	   	   	    
      ...
      case 0x14: 
				 ...
				 printf("Block %3d Length %6d    Pure Data ,Pause: %4d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);
      ...
      case 0x15: 
				 ...
				 printf("Block %3d Length %6d   Direct Rec ,Pause: %4d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);
      ...
      case 0x20: 
	  			 pause = Get2(&mem[pos]);
				 ustape += 1000*pause;
				 printf("Block %3d Length %6d  Pause Block ,Pause: %4d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);
				 block++;
				 pos += 0x02; 
				 break;

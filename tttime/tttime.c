  ...
  while (pos < flen - 10)
    ...
    switch (mem[pos - 1])
      ...
      case 0x10: 	 	 	  
				 ...
				 printf("Block %3d Length %5d Normal Speed ,Pause: %5d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);
      ...
      case 0x11: ticksPilotPulse = Get2(&mem[pos]);
				 ...
				 //printf("\n Len: %dchars, Ones: %dbits, acctime: %dus\n", len, BLKnumOnes, ustape);
				 printf("Block %3d Length %5d  Turbo Speed ,Pause: %5d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);	   	   	   	    
      ...
      case 0x14: 
				 ...
				 printf("Block %3d Length %5d    Pure Data ,Pause: %5d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);
      ...
      case 0x15: 
				 ...
				 printf("Block %3d Length %5d Direct Recor ,Pause: %5d ms ,ETA: %6d ms \n", block, len , pause, ustape/1000);
